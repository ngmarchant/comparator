...
setClass("Lookup", contains = c("StringMeasure"), 
         ...
         validity = function(object) {
           ...
           if (object@default_match < 0 || length(object@default_match) != 1)
             errs <- c(errs, "`default_match` must be a non-negative numeric vector of length 1")
           if (object@default_nonmatch < 0 || length(object@default_nonmatch) != 1)
             errs <- c(errs, "`default_nonmatch` must be a non-negative numeric vector of length 1")
